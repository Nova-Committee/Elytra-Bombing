...
public class EBTools {
    ...
    //Maths
    public static int getPositiveOrZero(int x) {
        return Math.max(x, 0);
    }

    public static float getPositiveOrZero(float x) {
        return Math.max(x, 0);
    }

    public static double getPositiveOrZero(double x) {
        return Math.max(x, 0);
    }

    public static short getPositiveOrZero(short x) {
        return (short) Math.max(x, 0);
    }
