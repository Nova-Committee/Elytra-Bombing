...
public class PlayerHandler {
    ...
    public static void launchTnt(PlayerEntity player, ItemStack igniter, ItemStack tntStack) {
        ...
        final double y = player.getPosY() - 0.5D;
        ...
        level.playSound(player, tnt.getPosX(), tnt.getPosY(), tnt.getPosZ(), SoundEvents.ENTITY_TNT_PRIMED, SoundCategory.BLOCKS, 1.0F, 1.0F);
