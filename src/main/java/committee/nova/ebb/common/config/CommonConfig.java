...
public class CommonConfig {
    public static final ForgeConfigSpec.IntValue TNT_FUSE_TIME;
    ...
    static {
        ...
        TNT_FUSE_TIME = BUILDER.comment("Elytra Bombing Setting", "How long should the launched TNT's fuse time be?", "Default is 80 ticks (4 sec), the same as Vanilla TNT.")
